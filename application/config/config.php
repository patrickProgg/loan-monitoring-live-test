...
$config['cookie_domain'] = '.loan-monitoring.alwaysdata.net'; // WITH leading dot
$config['cookie_path'] = '/';
$config['cookie_secure'] = TRUE;
$config['cookie_httponly'] = TRUE;
$config['cookie_samesite'] = 'None'; // Change to 'None' for cross-domain AJAX

// // Change ONLY these lines:
// $config['sess_driver'] = 'database';  // ← CHANGE THIS
// $config['sess_save_path'] = 'ci_sessions';  // ← CHANGE THIS
// $config['sess_match_ip'] = FALSE;
// $config['sess_time_to_update'] = 300;
// $config['sess_regenerate_destroy'] = FALSE;

// // Keep cookie settings the same:
// $config['cookie_prefix'] = '';
